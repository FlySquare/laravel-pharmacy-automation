...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ route('dashboard') }}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">KAŞE Ecza</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">{{ session('admin')->email }}</a>
                </div>
            </div>
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('tum-ilaclar') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Tüm İlaçlar</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('ilac-ekle') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Yeni İlaç Ekle</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('tum-siparisler') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Tüm Siparişler</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('siparis-ekle') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Yeni Siparişler Ekle</p>
                                </a>
                            </li>
                        </ul>
                    </li>
    ...
    <footer class="main-footer">
        <strong>Şeyma & Kader tarafından yapılmıştır.</strong>
